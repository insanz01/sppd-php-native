...
<script>
  ...
  const loadData = async () => {
    return await axios.get(`<?= $base_url ?>/api/get-produsen.api.php`).then(res => res.data);
  }
      ...
      if(role_id == 1) {
        ...
        temp += `
                <td>
                  ...
                  <a href="?page=produsen&action=edit&id=${res.id}" class="btn btn-primary float-right mx-2" role="button">
